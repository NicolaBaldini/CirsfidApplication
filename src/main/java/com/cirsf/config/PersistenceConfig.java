...
//import com.cirsf.model.UserCause;
...
@ComponentScans(value = { @ComponentScan("com.cirsf.dao"),
    @ComponentScan("com.cirsf.service") })
public class PersistenceConfig {
  ...
  public LocalSessionFactoryBean getSessionFactory() {
    ...
    factoryBean.setAnnotatedClasses(User.class, Authorities.class,CausePersist.class,Person.class,PrologResult.class,
    		Claim.class,Contract.class);
    return factoryBean;
  }
